                                            ...
                                            <div class="form-group">
                                                <label>Origen de la llamada :</label>
                                                    <label class="custom-control custom-radio">
                                                        <input name="origen_llamada" value="LineaSeguridad" type="radio" class="custom-control-input">
                                                        <span class="custom-control-label">Linea de seguridad</span>
                                                    </label>
                                                    <label class="custom-control custom-radio">
                                                        <input name="origen_llamada" value="CincoTres" type="radio" class="custom-control-input">
                                                        <span class="custom-control-label">*5533</span>
                                                    </label> 
                                                    <label class="custom-control custom-radio">
                                                        <input name="origen_llamada" value="NueveOnce" type="radio" class="custom-control-input">
                                                        <span class="custom-control-label">911</span>
                                                    </label> 
                                                    <label class="custom-control custom-radio">
                                                        <input name="origen_llamada" value="whats" type="radio" class="custom-control-input">
                                                        <span class="custom-control-label">Whatsapp</span>
                                                    </label> 
                                                    <label class="custom-control custom-radio">
                                                        <input name="origen_llamada" value="turista" type="radio" class="custom-control-input">
                                                        <span class="custom-control-label">Turista</span>
                                                    </label>
                                                    <label class="custom-control custom-radio">
                                                        <input name="origen_llamada" value="correo" type="radio" class="custom-control-input">
                                        ...
                                        <section>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>¿Pertenece a un programa especial?:</label>
                                                            ...
                                                            <label class="custom-control custom-radio">
                                                                <input value="no" name="SiProEspecial" type="radio" class="custom-control-input">
                                                                <span class="custom-control-label">No</span>
                                                            </label> 
                                            ...
                                            <div class="row" id="LugarHechos" style="display: none">
                                                ...
                                                <div class="row">            
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="lugar_hechos_cp">Codigo Postal : <span class="danger">*</span> </label>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="wfirstName2">No. Ext : <span class="danger">*</span> </label>
                                                            <input type="text" class="form-control " id="temp_lugar_hechos_no_ext" name="temp_lugar_hechos_no_ext">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="wfirstName2">No. Int : <span class="danger">*</span> </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control " id="temp_lugar_hechos_telefono" name="temp_lugar_hechos_telefono">
                                                        </div>
                                                    </div>
