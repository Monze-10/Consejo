                                ...
                                <form class="validation-wizard wizard-circle">
                                    ...
                                    <section>
                                        ...
                                        <div class="Necesidades">
                                            ...
                                            <div class="Necesidad" style="display: none" id="1">

                                                <h3 class="box-title">Extorsión Telefónica/Fraude</h3> 
                                                <hr class="m-t-0 m-b-20">
                                            ...
                                            <!--div para companimal-->
                                            <div class="Necesidad" style="display: none" id="4">
                                                
                                                <h3 class="box-title">Protección a los animales</h3> 
                                                <hr class="m-t-0 m-b-20">
                                            ...
                                            <!--aqui termina no companimal-->
                                            
                                            <!--div para suicidio-->
                                            <div class="Necesidad" style="display: none" id="13">

                                                <h3 class="box-title">Suicidio</h3> 
                                                <hr class="m-t-0 m-b-20">
                                            ...
                                            <div class="Necesidad" style="display: none" id="27">

                                                <h3 class="box-title">Maltrato infantil</h3> 
                                                <hr class="m-t-0 m-b-20">
                                            ...
                                            <div class="Necesidad" style="display: none" id="35">

                                                <h3 class="box-title">Violencia familiar</h3> 
                                                <hr class="m-t-0 m-b-20">
                                            ...
                                            <div class="Necesidad" style="display:none;" id="40">

                                            
                                                <h3 class="box-title">Línea Plateada</h3> 
                                                <hr class="m-t-0 m-b-20">
                                            ...
                                            <div class="Necesidad" style="display: none" id="43">

                                                <h3 class="box-title">Comisión Ciudadana contra la corrupción policial</h3> 
                                                <hr class="m-t-0 m-b-20">
                                            ...
                                            <!-- Empieza el div de informativa -->

                                            <div class="Necesidad" style="display: none" id="42">

                                                <h3 class="box-title">Informativa</h3> 
                                                <hr class="m-t-0 m-b-20">
